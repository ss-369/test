...
/**
 * Shows a spinner element.
 * 
 * @param id Spinner element ID
 */
r.util.showSpinner = function (id) {
  $('#' + id).html(r.util.buildLoader()).show();
};

/**
 * Hides a spinner element.
 * 
 * @param id Spinner element ID
 */
r.util.hideSpinner = function (id) {
  $('#' + id).hide();
};
 ...
 */
r.util.showError = function (message) {
